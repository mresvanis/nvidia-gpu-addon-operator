...
require (
	github.com/Mellanox/k8s-rdma-shared-dev-plugin v1.3.2
	github.com/Mellanox/network-operator v1.1.0
...
require (
	...
	github.com/k8snetworkplumbingwg/sriov-network-device-plugin v2.1.0+incompatible // indirect
	...
	k8s.io/kubelet v0.17.2 // indirect
